<template>
	<div>
		...
		<tab-bottom :on-select="tabChangeHandle" :style="style1">
			<tab-item event-key="电话">电话</tab-item>
			<tab-item event-key="短信">短信</tab-item>
			<tab-item event-key="我">我</tab-item>
			<tab-item event-key="照相">照相</tab-item>
		</tab-bottom>
